/**
 * Task: semper
 * Description: Compile Semperr templates to HTML
 * Dependencies: semper
 * Contributor: @errcw
 */
...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask("semper", "Compile Semper templates into HTML.", function() {
    ...
    this.files.forEach(function(file) {
      ...
      srcFiles.forEach(function(srcFile) {
        ...
        sourceCompiled = grunt.helper("semper", sourceCode, helperOptions, helperData);
  ...
  grunt.registerHelper("semper", function(src, options, data) {
    try {
      var semper = require("semper");
      var compiled = semper.parse(src);
      return semper.expand(compiled, null, data);
    } catch (e) {
      grunt.log.error(e);
      grunt.fail.warn("Semper failed to compile.");
    }
  });
};
